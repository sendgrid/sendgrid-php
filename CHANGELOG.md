...
- PR [#475](https://github.com/sendgrid/sendgrid-php/pull/475): Add documentation for setting up domain authentication, thanks to [Sourav Sarkar](https://github.com/amsourav) for the PR!
