...
class SendGridTest_Email extends PHPUnit_Framework_TestCase
{
    ...
    public function testAddAttachment()
    {
        ...
        $this->assertEquals(
            ...
            $msg_attachments[count($msg_attachments) - 1]['file']
        );
    }
    ...
    public function testToWebFormatWithFilters()
    {
        ...
        $this->assertEquals(
            'Here is a plain text footer',
            $xsmtpapi['filters']['footer']['settings']['text/plain']
        );
    }
}
