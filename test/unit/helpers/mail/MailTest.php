...
class MailTest_Mail extends \PHPUnit_Framework_TestCase
{
    public function testBaseLineExample()
    {
        ...
        $this->assertEquals($json, '{"from":{"email":"dx@sendgrid.com"},"personalization":[{"to":[{"email":"elmer.thomas@sendgrid.com"}]}],"subject":"Hello World from the SendGrid PHP Library","content":[{"type":"text\/plain","value":"some text here"},{"type":"text\/html","value":"<html><body>some text here<\/body><\/html>"}]}');
    }
